...
public:
	...
	uint s, initStep, iter, maxCCCPIter, nCla, nSamp, nFeats, m, verbose;
	...
	//Main constructor
	Model(std::vector<MatrixXT> _W, std::vector<MatrixXT> _W2, MatrixXT _localBetaClass,  T _lambda, T _p, T _tau, uint _maxCCCPIter, T _nRep, bool _averaging, uint _initStep, uint _s0, uint _verbose, bool _returnLocalBeta);

	//Main setter method
	void setParams(std::vector<MatrixXT> _W, std::vector<MatrixXT> _W2, MatrixXT _localBetaClass,  T _lambda, T _p, T _tau, uint _maxCCCPIter, T _nRep, bool _averaging, uint _initStep, uint _s0, uint _verbose, bool _returnLocalBeta);
